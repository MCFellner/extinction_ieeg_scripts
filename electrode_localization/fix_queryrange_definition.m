...
%allsubs = {'c_sub01','c_sub02','c_sub03','c_sub04','c_sub05','c_sub06','c_sub07','c_sub08','c_sub09','c_sub10',...
%          'c_sub11','c_sub13','c_sub14','c_sub15','c_sub16'};
...
%path_anat=strcat(path_data,'data\freesurfer_anat\output\',sel_sub,'\freesurfer\mri\'); % for p_sub
path_anat=strcat(path_data,'data\freesurfer_anat\output\',sel_sub,'\fieldtrip\',sel_sub,'\');% for c_sub
...
datainfo.elec_info.ana_labels.query_ranges=query_range;
    ...
    save(strcat(info_file),'datainfo')
